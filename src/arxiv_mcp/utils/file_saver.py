...
class FileSaver:
    ...
    def save_latex_files(self, arxiv_id: str, files: Dict[str, bytes], 
                        main_tex_file: str) -> Dict[str, str]:
    ...
    def save_markdown_file(self, arxiv_id: str, markdown_content: str, 
    ...
    def _generate_yaml_frontmatter(self, metadata: Dict[str, Any]) -> str:
        ...
        yaml_str = yaml.dump(yaml_metadata, default_flow_style=False, 
    ...
    def cleanup_old_files(self, days_old: int = 30) -> Dict[str, int]:
        ...
        logger.info(f"Cleaned up {cleaned_latex} LaTeX and {cleaned_markdown} markdown paper directories")
