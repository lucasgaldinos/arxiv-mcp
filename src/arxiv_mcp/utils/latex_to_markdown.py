...
class LaTeXToMarkdownConverter:
    ...
    def convert(self, latex_content: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def _convert_with_pandoc(self, latex_content: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def _convert_with_fallback(self, latex_content: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def convert_with_metadata(self, latex_content: str, arxiv_id: Optional[str] = None) -> Dict[str, Any]:
