...
from ..processors import LaTeXProcessor, PDFProcessor
...
class ArxivPipeline:
    ...
    async def process_multiple_papers(self, arxiv_ids: List[str], include_pdf: bool = True) -> List[Dict[str, Any]]:
        """Process multiple ArXiv papers concurrently."""
        self.logger.info(f"Starting batch processing for {len(arxiv_ids)} papers")
        
        # Create tasks for concurrent processing
        tasks = [
            self.process_paper(arxiv_id, include_pdf)
