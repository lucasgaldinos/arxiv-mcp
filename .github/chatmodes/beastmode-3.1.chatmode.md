...
You must use the websearch tool to recursively gather all information from URL's provided to  you by the user, as well as any links you find in the content of those pages.
...
1. Fetch any URL's provided by the user using the `websearch` tool.
