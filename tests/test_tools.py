...
class TestMCPToolsCore:
    ...
    async def test_handle_search_arxiv_success(self):
        ...
        with patch("arxiv_mcp.tools.ArxivAPIClient") as mock_client_class:
            ...
            result = await handle_search_arxiv(query="test query", max_results=10)
    ...
    async def test_handle_download_paper_success(self):
        ...
        with (
            patch("arxiv_mcp.tools.ArxivPipeline") as mock_pipeline_class,
            patch("arxiv_mcp.core.config.PipelineConfig") as mock_config_class,
        ):
    ...
    async def test_handle_fetch_arxiv_paper_content_success(self):
        ...
        with (
            ...
            # Call the function
            result = await handle_fetch_arxiv_paper_content(arxiv_id="2404.04895", include_pdf=True)
    ...
    def test_handle_process_document_formats_supported_formats(self):
        ...
        with patch(
            "arxiv_mcp.processors.document_processor.DocumentProcessor"
    ...
    async def test_handle_download_and_convert_paper_success(self):
        ...
        with patch(
            "arxiv_mcp.utils.unified_converter.download_and_convert_paper"
            ...
            result = await handle_download_and_convert_paper(
                arxiv_id="2404.04895", output_dir="./output", save_latex=True, save_markdown=True
            )
...
class TestMCPToolsBatch:
    ...
    async def test_handle_batch_download_and_convert_success(self):
        ...
        with patch(
            "arxiv_mcp.utils.unified_converter.UnifiedDownloadConverter"
            ...
            result = await handle_batch_download_and_convert(
                arxiv_ids=arxiv_ids, output_dir="./output"
            )
...
class TestMCPToolsIntegration:
    ...
    async def test_batch_processing_with_error_handling(self):
        ...
        # Placeholder for complex batch test
